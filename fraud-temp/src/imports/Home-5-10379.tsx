import svgPaths from "./svg-ljid5fda69";
import { imgIcon } from "./svg-3kehz";
    ...
    <div className="relative shrink-0 size-[24px]" data-name="add_column_left">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="add_column_left">
          <mask height="24" id="mask0_5_11671" maskUnits="userSpaceOnUse" style={{ maskType: "alpha" }} width="24" x="0" y="0">
            <rect fill="var(--fill-0, #121621)" height="24" id="Bounding box" width="24" />
          </mask>
          <g mask="url(#mask0_5_11671)">

...
export function Sidebar() {
      ...
      <div className="shrink-0 w-full">
        <div className="flex items-center justify-between px-[12px] py-[8px]">
          {bottomItems.map(({ label, icon, vb }) => (
            ...
            >
              <div className="flex flex-col items-center justify-center p-[8px] rounded-[4px] hover:bg-[rgba(255,255,255,0.08)] transition-colors">
  ...
  return (
    <div
      ...
      style={{ width: 272 }}
    >
      {isSalesActive ? SalesView : FullNav}
    </div>
  );
}